...
- **[`wilcoxauc()`](https://immunogenomics.github.io/presto/reference/wilcoxauc.md)**
  — Wilcoxon rank-sum test and area-under-the-ROC across groups, fast
  enough to run on whole-genome × hundred-thousand- cell matrices in
  seconds.
- **[`pseudobulk_deseq2()`](https://immunogenomics.github.io/presto/reference/pseudobulk_deseq2.md)**
  — collapse cells into per-donor pseudobulks with
  [`collapse_counts()`](https://immunogenomics.github.io/presto/reference/collapse_counts.md)
  and run a count-based regression with `DESeq2` in one-vs-all,
  pairwise, or within-cluster designs.
...
[`DESeq2`](https://bioconductor.org/packages/DESeq2/), which lives in
`Suggests`, so you only need it if you use that feature.
...
summarises the most distinguishing features per group:
...
For full examples on a real 25,000-cell single-cell RNA-seq dataset,
see:

- [**Getting
  started**](https://immunogenomics.github.io/presto/articles/getting-started.html)
  —
  [`wilcoxauc()`](https://immunogenomics.github.io/presto/reference/wilcoxauc.md)
  and
  [`top_markers()`](https://immunogenomics.github.io/presto/reference/top_markers.md)
  for marker discovery, including a description of every output column
  and how to restrict the comparison to a subset of groups.
- [**Pseudobulk differential expression with
  DESeq2**](https://immunogenomics.github.io/presto/articles/pseudobulk.html)
  —
  [`collapse_counts()`](https://immunogenomics.github.io/presto/reference/collapse_counts.md)
  and the three
  [`pseudobulk_deseq2()`](https://immunogenomics.github.io/presto/reference/pseudobulk_deseq2.md)
  modes (one-vs-all, pairwise, within), plus
...
A benchmark on 1,000,000 observations × 1,000 features × 10 groups runs
in 16 seconds on sparse input and 85 seconds on dense input.
